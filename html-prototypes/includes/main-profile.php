<article class="profile">
  ...
  <header class="h-card vcard">
    ...
    <span class="p-job-title title">Director of Scholarly Communication</span> <span class="p-org org">Modern Language Association</span>
    <span class="h-adr"><span class="p-locality">New York, </span><span class="p-region">NY, </span><span class="p-country-name">USA</span></span>
    <ul class="contact-info">
      <li><a class="u-email email" href="mailto:oo@example.net" rel="me"><span>oo@example.net</span></a></li>
      <li><a class="u-url url www" href="http://www.example.net" rel="external me"><span>www.example.net</span></a></li>
      <li><a class="p-tel tel" href="tel:+19175551234" rel="me"><span>917.555.1234</span></a></li>
      <li><a class="u-url url twitter" href="https://twitter.com/kfitz" rel="me"><span>@kfitz</span></a></li>
